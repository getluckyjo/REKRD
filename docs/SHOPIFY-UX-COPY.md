...
### Homepage
1. **Hero** — eyebrow `CLEAN HYDRATION · PRETORIA, ZA`; H1 "*ready.* *set.* HYDRATE." (stacked three lines — first two italic serif, last in bold display caps); lede: "Electrolytes, minerals and nothing you don't need — in a tube you'll keep long after the last sachet. Five flavours. Zero fillers. Third-party tested." CTAs: `SHOP THE 30 — R600` / `TRY THE 5 — R100`.
